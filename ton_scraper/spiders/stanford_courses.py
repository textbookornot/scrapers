...
class StanfordCourseSpider(scrapy.Spider):
    ...
    def parse_subject(self, response):
        ...
        # determine the subject of the courses being scraped
        current_subject_code = response.xpath('//span[@class="searchTerm"]/text()').extract()[0].strip()
        ...
        for course in response.xpath('//div[@class="courseInfo"]'):
            ...
            item['subject_code'] = current_subject_code
            item['subject_title'] = self.subject_list[current_subject_code]
